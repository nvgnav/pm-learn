  ...
  return (
    <div className="home-page">
      ...
      <div className={`side-menu ${menuOpen ? "open" : ""}`}>
        ...
        <button className="side-menu-item selected" onClick={() => navigate("/practice")}>
          Практика
        </button>
      ...
      <main className="home-main">
        <div className="content-block">
          ...
          <p>
            Здесь будет располагаться раздел с практическими заданиями. Пользователь
            сможет открывать задание, знакомиться с условием, выполнять работу и
            отправлять решение на проверку.
          </p>
        </div>
      </main>
    </div>
