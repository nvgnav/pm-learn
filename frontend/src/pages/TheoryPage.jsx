  ...
  return (
    <div className="home-page">
      ...
      <div className={`side-menu ${menuOpen ? "open" : ""}`}>
        ...
        <button className="side-menu-item selected" onClick={() => navigate("/theory")}>
          Теория
        </button>
      ...
      <main className="home-main">
        <div className="content-block">
          ...
          <p>
            Здесь будет размещён раздел с теоретическими материалами по дисциплине.
            На этой странице можно будет просматривать темы, переходить между
            модулями и изучать учебный контент.
          </p>
        </div>
      </main>
    </div>
